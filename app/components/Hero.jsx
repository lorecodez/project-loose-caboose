  ...
  return (
    <section className='flex items-center w-full h-full px-6 py-3 '>
      <aside className='w-1/2 flex flex-col items-start justify-center gap-7'>
        ...
        <button className='px-6 py-3 rounded-full bg-red-600 text-stone-50 text-5xl shadow-xl font-bold hover:bg-orange-500 duration-200 transition-all ease-linear'>
          Contact Us
        </button>
        <button className='px-6 py-3 rounded-full bg-amber-950 text-stone-50 text-5xl shadow-xl font-bold hover:bg-orange-500 duration-200 transition-all ease-linear'>
          View schedule
        </button>
